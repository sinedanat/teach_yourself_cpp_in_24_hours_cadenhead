...
void myFunction(LinkedList<Cat>& listOfCats)
{
    ...
    while (true)
    {
        std::cout << "How old is your cat (0 to stop)? ";
        std::cin >> val;
...
// How old is your cat (0 to stop)? 7
// How old is your cat (0 to stop)? 1
// How old is your cat (0 to stop)? 4
// How old is your cat (0 to stop)? 2
// How old is your cat (0 to stop)? 3
// How old is your cat (0 to stop)? 0
// What value (0 to stop)? 0
// 
// This cat is 1 years old
