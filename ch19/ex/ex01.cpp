// Rewrite the LinkedList program (Listing 19.1)
// to hold Tricycle objects rather than integers.
...
// constructor
Tricycle::Tricycle(int newSpeed) : speed(newSpeed)
{}
...
// constructor
Data::Data(const Tricycle &newTrike): trike(newTrike)
{
...
{
    if (trike.getSpeed() < otherData.trike.getSpeed())
        return kIsSmaller;
...
int main()
{
    ...
    while (true)
    {
        ...
        pTricycle = new Tricycle(val);
        pData = new Data(*pTricycle);
        ll.insert(pData);
    }
