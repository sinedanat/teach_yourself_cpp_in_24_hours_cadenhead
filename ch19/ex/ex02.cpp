// Add a function to the LinkedList class (Listing 19.1)
// that displays a count of the number of nodes the list contains.
...
int main()
{
    ...
    std::cout << "Number of nodes: " << ll.getCount() << "\n";

    return 0;  // ll falls out of scope and is destroyed!
}

// What value (0 to stop)? 52
// What value (0 to stop)? 14
// What value (0 to stop)? 23
// What value (0 to stop)? 68
// What value (0 to stop)? 444
