...
inline String::String(const char* const cString)
{
    len = strlen(cString);
    value = new char[len + 1];
    int i;
...
inline char& String::operator[](int offset)
{
    if (offset > len)
        return value[len - 1];
    else
...
inline char String::operator[](int offset) const
{
    if (offset > len)
        return value[len - 1];
    else
...
inline void String::operator+=(const String& rhs)
{
...
inline int String::constructorCount = 0;
